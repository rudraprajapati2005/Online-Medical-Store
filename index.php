...
<body>
 <div class="container">
     <div class="info">
         <h1>Welcome to Medicine Company</h1>
         ...
         <ul>
             ...
             <li>User : user are only allowed to view and order medicine. and if you are a user than you are always permitted to go inside website without password.</li>
         </ul>
     </div>
 ...
 <select id="tablename" name="tablename">
    ...
    <input class="input_pass" type="text" name="password" PLACEHOLDER="Input Password Here"> </input>
    <p id="warning"></p>
    <br>
